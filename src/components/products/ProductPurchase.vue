        ...
        <div class="col-6 offset-3 pt-3 card mt-5 shadow">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea v-model="product.description" cols="30" rows="3" placeholder="Ürüne ait bir açıklama giriniz..." class="form-control"></textarea>
...
export default {
    ...
    computed: {
        saveEnabled(){
            if(this.product.title.length > 0 && this.product.count > 0 && this.product.price > 0 && this.description.length > 0){
                return false;
            }else{
                return true;
            }
    ...
    beforeRouteLeave (to, from, next) {
            if((this.product.title.length > 0 || this.product.count > 0 || this.product.price > 0 || this.description.length > 0 && !this.saveButtonClicked)){
